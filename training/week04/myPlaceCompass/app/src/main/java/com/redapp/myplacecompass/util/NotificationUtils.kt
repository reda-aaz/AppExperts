...
import com.redapp.myplacecompass.ui.view.HomeActivity
...
fun NotificationManager.sendGeofenceEnteredNotification(context: Context, foundIndex: Int) {
    ...
    val builder = NotificationCompat.Builder(context, CHANNEL_ID)
        ...
        .setContentText(context.getString(R.string.content_text,
            context.getString(GeofencingConstants.LANDMARK_DATA[foundIndex].message)))
        .setPriority(NotificationCompat.PRIORITY_HIGH)
        .setContentIntent(contentPendingIntent)
        .setSmallIcon(R.drawable.eiffel)
